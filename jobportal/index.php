...
<!-- NAVBAR -->
  ...
  <!--Corsule -->
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="img/raj.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Rajdeep Chatterjee</h2>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="img/shivangi.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Shivangi Kumari</h2>
        </div>
        <div class="col-lg-4">
          <img class="img-circle" src="img/riya.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Ria </h2>
        </div>
      </div><!-- /.row -->
      ...
      <footer>
        ...
        <p>&copy; 2018 JobsFinder &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
